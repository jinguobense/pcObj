		...
		<el-container>
			...
			<el-container>
				<el-main>
					...
					<div class="content">
						<div class="titlebar">
							<span class="fenl1">申请退款中订单列表</span>
							<div class="yoou">
						...
						<div class="tablebox">
							...
							<el-table :data="tableData1" style="width: 100%" row-key="id" border stripe lazy :tree-props="{children: 'children', hasChildren: 'hasChildren'}">
								<el-table-column label="订单号" width="220" @row-click="lookinfo" fit='true'>
				...
				<div class="tablebox" >
					...
					<table class="table" align="center" border="1" cellpadding="0px" cellspacing="0px">
						<tr>
							...
							<td  style="color: red;width: 400px;">
								<span>申请退款中</span>
								<!-- <span v-if="dantian.state==0">待付款</span>
								<span v-if="dantian.state==1">待发货</span>
								<span v-if="dantian.state==3 && dantian.rfstate==0">申请退款中</span>
							...
							<td class="text">订单状态来源:</td>
							<td >
								<span v-if="dantian.state==0">待付款</span>
								<span v-if="dantian.state==1">待发货</span>
								<span v-if="dantian.state==3 && dantian.rfstate==0">待评价</span>
