			...
			<el-container>
				...
				<el-container>
					<el-main>
						...
						<div class="content">
							<div class="titlebar">
								<span class="fenl1">大众拼团轮播广告列表</span>
								<div class="yoou">
									<div @click="xinjian">
							...
							<div class="addwrap">
								...
								<table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
									<tr>
										...
										<td class="ggtu1">
											<div class="kfjbvm">
												<el-upload class="avatar-uploader" action="https://www.xashudezhao.com/helpsales/platform/uploadImg" :show-file-list="false"
