			...
			<el-container>
				...
				<el-container>
					<el-main>
						...
						<div class="content">
							...
							<div class="searchbox">
								<div class="search">
									...
									<el-date-picker v-model="creteome" type="daterange" size="small" range-separator="至" start-placeholder="开始时间"
									...
									<el-table-column fixed="right" label="审核状态" width="120">
										<template slot-scope="scope">
											<div class="setbox">
												...
												<div @click="xiugaidome(scope.row.id)" v-if="scope.row.checkstate==0" style="cursor: pointer;">审核中</div>
						...
						<!-- <el-dialog title="满减商品详情" :visible.sync="dialogVisible" width="1200px" height="840px" :before-close="handleClose"> -->
						...
						<div class="addbox" v-if="shenhe">
							...
							<div class="addwrap">
								...
								<div class="tablebox">
									...
									<table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
										<tr  class="shuxin">
											<td style="width: 400px;" class="shuxin3">规格</td>
											<td class="shuxin3">单价</td>
											<!-- <td class="shuxin3">原价</td>
 -->

										</tr>
										<tr  v-for="(item,index) in shenheye.tGoodsSku" :key="index">
											<td>
												<div class="shuxin4">{{item.value1}}</div>
											</td>
