					...
					<el-main>
						...
						<div class="content">
							<div class="titlebar">
								...
								<span class="fenl1">大众拼团列表</span>
								<div class="yoou">

									<img src="../../assets/img/shanchu.png" alt="" class="imgone1" @click="open">
									<img src="../../assets/img/shuaxinbai.png" alt="" class="imgone1" @click="shuxinym">
							...
							<div class="tablebox620">
								<el-table ref="multipleTable" :data="tableData" border tooltip-effect="dark" style="width: 100%" @select="deld"
								 @select-all="quanxuan" stripe>
									...
									<el-table-column prop="pratio" label="平台提成比例" width="150">
									</el-table-column>
									...
									<el-table-column label="状态" width="120" fixed="right">
										<template slot-scope="scope">
											<div>
												<span class="topjia" v-if="scope.row.state==0" @click="addjia(scope.row.id)" style="font-size: 16px;">上架</span>
												<span class="topjia" v-if="scope.row.state==1" @click="addjia(scope.row.id)" style="font-size: 16px;">下架</span>
												
												<el-button @click.native.prevent="deleteRow(scope.$index, tableData)" type="text" size="small" v-if="scope.row.state==0"
												 @click="downjia(scope.row.id)" style="color: #0b9cf4; font-size: 16px;">
													下架
												</el-button>
											</div>
									...
									<el-table-column fixed="right" label="审核状态" width="120">
										<template slot-scope="scope">
											<!-- <span class="topjia" v-if="scope.row.checkstate==1">已通过</span>
											<el-button @click.native.prevent="deleteRow(scope.$index, tableData)" type="text" size="small" @click="xiugaidome(scope.row.id)"
											 v-if="scope.row.checkstate==0">
												审核中
											</el-button>
											
											<span class="topjia" v-if="scope.row.checkstate==2">已弃审</span> -->
											<div class="setbox">
						...
						<!-- <el-dialog title="" :visible.sync="dialogVisible" width="1200px" height="840px" :before-close="handleClose"> -->
						<div class="addbox" v-if="dialogVisible">
							...
							<div class="addwrap">
								<div class="title">商品详情</div>
									...
									<div class="tablebox">
									<div class="tablebox" v-if="fenggeadd==1">
									...
									<div class="tablebox" v-if="fenggeadd==2">
										<table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
											<tr class="oneli">
						...
						<!-- </el-dialog> -->
						<!-- <el-dialog title="" :visible.sync="shenhe" width="1200px" height="840px" :before-close="handleClose"> -->
	...
	export default {
		...
		methods: {
			...
			downjia(e) {
				...
				this.$confirm('确认要下架该厂家商品记录?', '系统提示', {
