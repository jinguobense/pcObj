			...
			<el-container>
				...
				<el-container>
					<el-main>
						...
						<div class="content">
							...
							<div class="searchbox">
								<div class="search">
									...
									<el-select size="medium" v-model="cckstat" placeholder="商品状态" @change="sousu">
										<el-option key="1" value="1" label="下架"></el-option>
										<el-option key="0" value="0" label="上架"></el-option>
									</el-select>
									<el-select size="medium" v-model="stet" placeholder="审核状态" @change="sousu">
						...
						<!-- <el-dialog title="两人团详情" :visible.sync="dialogVisible" width="1200px" height="840px" :before-close="handleClose"> -->
								...
								<div v-if="fenggeadd==2">
									...
									<table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
										...
										<tr class="" v-for="(item,index) in xqshops.tGoodsSku" :key="index">
											...
											<td class="shuxin2">{{item.costprice}}</td>
						...
						<!-- </el-dialog> -->
						<!-- 	<el-dialog title="审核商品信息" :visible.sync="shenhe" width="1080px" height="840px" :before-close="handleClose"> -->
								...
								<div class="tablebox">
									...
									<table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
										...
										<tr class="" v-for="(item,index) in shenheye.tGoodsSku" :key="index">
											...
											<td class="shuxin4">{{item.costprice}}</td>
