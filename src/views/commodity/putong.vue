			...
			<el-container>
				...
				<el-container>
					<el-main>
								...
								<el-table ref="multipleTable" :data="tableData" border tooltip-effect="dark" style="width: 100%"
								 @selection-change="handleSelectionChange" @select="deld"  @select-all="quanxuan" stripe>
									...
									<el-table-column label="状态" width="120" fixed="right">
										<template slot-scope="scope" >
											<div>
												<span class="topjia" v-if="scope.row.state==0"  style="font-size: 16px; cursor: pointer;">上架</span>
												<span class="topjia" v-if="scope.row.state==1"  style="font-size: 16px; cursor: pointer;">下架</span>
									...
									<el-table-column fixed="right" label="审核状态" width="120">
										<template slot-scope="scope">
											<div class="setbox">
											           <div  v-if="scope.row.checkstate==1" style="color: black; cursor: pointer;">已通过</div>
											           <div  @click="xiugaidome(scope.row.id)" v-if="scope.row.checkstate==0" >审核中</div>
											          <div  v-if="scope.row.checkstate==2" style="color: black; cursor: pointer;">已弃审</div>
											          </div>
										</template>
									</el-table-column>
								</el-table>
						...
						<!-- <el-dialog title="普通商品详情" :visible.sync="dialogVisible" width="1200px" height="840px" :before-close="handleClose"> -->
									...
									<div v-if="fenggeadd==1">
										<table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
											...
											<tr>
												...
												<td class="td4">
													<span>{{xqshops.pfgtypeidName}}</span>
												</td>
											</tr>
											<tr>
												<td class="td3">
										...
										<table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
											<tr>
												<td class="suixin">商品单位</td>
												<td class="suiyi">{{xqshops.unitName}}</td>
												<td class="suixin">单位续件运费</td>
												<td class="suiyi">{{xqqujian[0].incFreight}}</td>
											</tr>
										</table>
										<div class="baoguo">
											<table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
												<tr>
													<td class="kisse"><span>第一区间批发数量：（大于等于该值）</span></td>
													<td class="kissr"><span>{{xqqujian[0].num1}}</span></td>
													<td class="kisse"><span>第一区间批发价格</span></td>
													<td class="kissr"><span>{{xqqujian[0].price1}}</span></td>
													<td class="kisse"><span>第一区间起步运费</span></td>
													<td class="kissr"><span>{{xqqujian[0].freight1}}</span></td>
												</tr>
												<tr>
													<td class="kisse"><span>第二区间批发数量：（大于等于该值）</span></td>
													<td class="kissr"><span>{{xqqujian[0].num2}}</span></td>
													<td class="kisse"><span>第二区间批发价格</span></td>
													<td class="kissr"><span>{{xqqujian[0].price2}}</span></td>
													<td class="kisse"><span>第二区间起步运费</span></td>
													<td class="kissr"><span>{{xqqujian[0].freight2}}</span></td>
												</tr>
												<tr>
													<td class="kisse"><span>第三区间批发数量：（大于等于该值）</span></td>
													<td class="kissr"><span>{{xqqujian[0].num3}}</span></td>
												<td class="kisse"><span>第三区间批发价格</span></td>
												<td class="kissr"><span>{{xqqujian[0].price3}}</span></td>
													<td class="kisse"><span>第三区间起步运费</span></td>
													<td class="kissr"><span>{{xqqujian[0].freight3}}</span></td>
												</tr>
													</table>
											<!-- <table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
												<tr>
													<td class="kisse">
														<span>第一区间批发数量：（大于等于该值）</span>
														</td>
													<td class="kissr"><span>{{xqqujian[0].num1}}</span></td>
									...
									<div v-if="fenggeadd==2">
										...
										<table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
											<tr class="shuxin">
												...
												<!-- <td class="shuxin1">活动价</td>
												<td class="shuxin1">原价</td> -->
											...
											<tr class="" v-for="(item,index) in xqshops.tGoodsSku" :key="index">
												...
												<td class="shuxin2">{{item.origprice}}</td> -->
								...
								<table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
										...
										<table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
											<tr>
												...
												<td class="td4" colspan="3">
													<span>{{shenheye.tGoodsSku[0].value1}}</span>
												</td>
											...
											<tr>
												...
												<td class="td4">
													<span>{{jiagequjian[0].num1}}</span>
												</td>
												<td class="td3">
													<span>第一区间批发价格:</span>
												</td>
												<td class="td4">
													<span>{{jiagequjian[0].price1}}</span>
												</td>
											</tr>
											<tr>
												<td class="td3">
												...
												<td class="td4">
													<span>{{jiagequjian[0].num2}}</span>
												</td>
												<td class="td3">
													<span>第二区间批发价格:</span>
												</td>
												<td class="td4">
													<span>{{jiagequjian[0].price2}}</span>
												</td>
											</tr>
											<tr>
												<td class="td3">
										...
										<!-- <table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
											<tr class="shuxin">
												...
												<td class="shuxin3" colspan="3"><span>
														规格
													</span></td>
										...
										<table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
											<tr>
												...
												<td rowspan="4" class="xi2">
													<el-image
													    style="width: 100px; height: 200px; margin-left: 20px;"
													    :src="shenheye.url" 
													    :preview-src-list="[shenheye.url]">
													  </el-image>
												</td>
												...
												<td class="ac2">
													<div>
														<el-input v-model="tichenbili" oninput="value=value.replace(/^\D*(\d*(?:\.\d{0,2})?).*$/g, '$1')" placeholder="请输入内容"  @blur='starBlur'></el-input>
													</div>
												</td>
											</tr>
											<tr>
		...
		methods: {
			...
			shopxq(e) {
				...
				shopxq('shop/getTGoodsDetail', params).then(res => {
					...
					_this.xqqujian=res.resultData.tGoodsWsBo
			...
			Getshopshenhe() {
				...
				Getshopshenhe('shop/getTGoodsChechDetail', params).then(res => {
					...
					this.jiagequjian=res.resultData.tGoodsWsBo
					console.log(this.jiagequjian,"444444444444")
				})
			},
			tijiao(e) {
				let _this = this
