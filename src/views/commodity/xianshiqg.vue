			...
			<el-container>
				...
				<el-container>
					<el-main>
						...
						<div class="content">
							<div class="titlebar">
								<span class="fenl1">限时抢购商品列表</span>
								<div class="yoou">
						...
						<!-- <el-dialog title="限时抢购商品详情" :visible.sync="dialogVisible" width="1200px" height="840px" :before-close="handleClose"> -->
						<div class="addbox" v-if="dialogVisible">
							<div class="mask"></div>
							<div class="addwrap">
								<div class="title">限时抢购商品详情</div>
								<div class="yetou">
								...
								<div class="tablebox">
									...
									<table align="center" border="1" cellpadding="0px" cellspacing="0px" class="biaoge">
										<tr>
											...
											<td class="ac2">
												<div>
													<el-input v-model="tichenbili"  placeholder="请输入内容" oninput="value=value.replace(/^\D*(\d*(?:\.\d{0,2})?).*$/g, '$1')" @blur='starBlur'></el-input>
												</div>
											</td>
										</tr>
										<tr>
